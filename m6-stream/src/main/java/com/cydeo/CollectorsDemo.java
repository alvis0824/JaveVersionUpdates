...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        //joining(): is used to join various elements of a character or String array into to a single object
        ...
        //groupingBy() : is used for grouping objects by some property and storing results in a Map instatnce
